...
GNU_EFI_VERSION			= 3.0.4
GNU_EFI_TARBALL			= gnu-efi-$(GNU_EFI_VERSION).tar.bz2
GNU_EFI_TARBALL_URLS		+= $(ONIE_MIRROR)
GNU_EFI_BUILD_DIR		= $(MBUILDDIR)/gnu-efi
...
GNU_EFI_SOURCE_STAMP		= $(STAMPDIR)/gnu-efi-source
GNU_EFI_PATCH_STAMP		= $(STAMPDIR)/gnu-efi-patch
GNU_EFI_BUILD_STAMP		= $(STAMPDIR)/gnu-efi-build
...
$(GNU_EFI_SOURCE_STAMP): $(TREE_STAMP) $(GNU_EFI_DOWNLOAD_STAMP)
	$(Q) rm -f $@ && eval $(PROFILE_STAMP)
