...
PESIGN_BUILD_DIR		= $(MBUILDDIR)/pesign
...
PESIGN_SOURCE_STAMP		= $(STAMPDIR)/pesign-source
PESIGN_PATCH_STAMP		= $(STAMPDIR)/pesign-patch
PESIGN_BUILD_STAMP		= $(STAMPDIR)/pesign-build
...
$(PESIGN_SOURCE_STAMP): $(TREE_STAMP) $(PESIGN_DOWNLOAD_STAMP)
	$(Q) rm -f $@ && eval $(PROFILE_STAMP)
...
$(PESIGN_BUILD_STAMP): $(PESIGN_PATCH_STAMP) $(PESIGN_NEW_FILES)
	$(Q) rm -f $@ && eval $(PROFILE_STAMP)
